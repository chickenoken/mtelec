...
const TableEmpl = () => {
  ...
  const schema = z.object({
    ceo_name1: z.string().min(1, 'Input is required'),
    ceo_image1: z.string().min(1, 'Input is required'),
    ceo_title1: z.string().min(1, 'Input is required'),
    ceo_tdesc1: z.string().min(1, 'Input is required'),
    ceo_desc1: z.string().min(1, 'Input is required'),

    ceo_name2: z.string().min(1, 'Input is required'),
    ceo_image2: z.string().min(1, 'Input is required'),
    ceo_title2: z.string().min(1, 'Input is required'),
    ceo_tdesc2: z.string().min(1, 'Input is required'),
    ceo_desc2: z.string().min(1, 'Input is required'),

    cm_name1: z.string().min(1, 'Input is required'),
    cm_image1: z.string().min(1, 'Input is required'),
    cm_title1: z.string().min(1, 'Input is required'),
    cm_desc1: z.string().min(1, 'Input is required'),

    cm_name2: z.string().min(1, 'Input is required'),
    cm_image2: z.string().min(1, 'Input is required'),
    cm_title2: z.string().min(1, 'Input is required'),
    cm_desc2: z.string().min(1, 'Input is required'),

    m_name1: z.string().min(1, 'Input is required'),
    m_image1: z.string().min(1, 'Input is required'),
    m_title1: z.string().min(1, 'Input is required'),
    m_desc1: z.string().min(1, 'Input is required'),

    m_name2: z.string().min(1, 'Input is required'),
    m_image2: z.string().min(1, 'Input is required'),
    m_title2: z.string().min(1, 'Input is required'),
    m_desc2: z.string().min(1, 'Input is required'),

    m_name3: z.string().min(1, 'Input is required'),
    m_image3: z.string().min(1, 'Input is required'),
    m_title3: z.string().min(1, 'Input is required'),
    m_desc3: z.string().min(1, 'Input is required'),

    sm_name1: z.string().min(1, 'Input is required'),
    sm_image1: z.string().min(1, 'Input is required'),
    sm_title1: z.string().min(1, 'Input is required'),
    sm_desc1: z.string().min(1, 'Input is required'),

    sm_name2: z.string().min(1, 'Input is required'),
    sm_image2: z.string().min(1, 'Input is required'),
    sm_title2: z.string().min(1, 'Input is required'),
    sm_desc2: z.string().min(1, 'Input is required'),

    sm_name3: z.string().min(1, 'Input is required'),
    sm_image3: z.string().min(1, 'Input is required'),
    sm_title3: z.string().min(1, 'Input is required'),
    sm_desc3: z.string().min(1, 'Input is required'),

    sm_name4: z.string().min(1, 'Input is required'),
    sm_image4: z.string().min(1, 'Input is required'),
    sm_title4: z.string().min(1, 'Input is required'),
    sm_desc4: z.string().min(1, 'Input is required'),
  })
