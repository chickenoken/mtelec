...
const FormElectricDesign = () => {
  ...
  const [originalData, setOriginalData] = useState<any>({});
	...
	const schema = z.object({
		name1: z.string().min(1, "Input is required"),
		image1: z.string().min(1, "Image is required"),
		name2: z.string().min(1, "Input is required"),
		image2: z.string().min(1, "Image is required"),
		name3: z.string().min(1, "Input is required"),
		image3: z.string().min(1, "Image is required"),
		name4: z.string().min(1, "Input is required"),
		image4: z.string().min(1, "Image is required"),
		name5: z.string().min(1, "Input is required"),
		image5: z.string().min(1, "Image is required"),
		name6: z.string().min(1, "Input is required"),
		image6: z.string().min(1, "Image is required"),
		name7: z.string().min(1, "Input is required"),
		image7: z.string().min(1, "Image is required"),
		name8: z.string().min(1, "Input is required"),
		image8: z.string().min(1, "Image is required"),
		name9: z.string().min(1, "Input is required"),
		image9: z.string().min(1, "Image is required"),
		name10: z.string().min(1, "Input is required"),
		image10: z.string().min(1, "Image is required"),
		name11: z.string().min(1, "Input is required"),
	...
	const handleSave = async () => {
      ...
      if(param.image8 === originalData.image8) param.image8 = '';
			if(param.image9 === originalData.image9) param.image9 = '';
      if(param.image10 === originalData.image10) param.image10 = '';
      if(param.image11 === originalData.image11) param.image11 = '';
